...
## Project Structure
    ...
    ├── crowdbotics_django__28594  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_django__28594`
...
2. Clone this repo and `cd crowdbotics_django__28594`
